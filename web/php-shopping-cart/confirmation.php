...
<body>
    ...
    <div class="jumbotron">
        <h1 class="display-4">Your Order Has Been Completed!</h1>
        <p class="lead"><strong>Address:</strong> <?php echo $_POST["inputAddress"]; ?></p>
        <p class="lead"><strong>City:</strong> <?php echo $_POST["inputCity"]; ?></p>
        <p class="lead"><strong>State:</strong> <?php echo $_POST["inputState"]; ?></p>
        <p class="lead"><strong>Zip:</strong> <?php echo $_POST["inputZip"]; ?></p></p>
